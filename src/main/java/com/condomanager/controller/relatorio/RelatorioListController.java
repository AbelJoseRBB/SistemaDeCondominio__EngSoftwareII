...
public class RelatorioListController {
    ...
    private void onGerarTaxas() {
        try {
            List<Taxa> taxas = relatorioService.gerarRelatorioTaxas(
                    dpDataInicial.getValue(), dpDataFinal.getValue()
            );
    ...
    private void onGerarReservas() {
        try {
            List<Reserva> reservas = relatorioService.gerarRelatorioReservas(
                    dpDataInicial.getValue(), dpDataFinal.getValue()
            );
    ...
    private void onGerarOcorrencias() {
        try {
            List<Ocorrencia> ocorrencias = relatorioService.gerarRelatorioOcorrencias(
                    dpDataInicial.getValue(), dpDataFinal.getValue()
            );
    ...
    private void onGerarManutencoes() {
        try {
            List<Manutencao> manutencoes = relatorioService.gerarRelatorioManutencoes(
                    dpDataInicial.getValue(), dpDataFinal.getValue()
            );
    ...
    private void configurarTabelaUnidades() {
        ...
        adicionarColuna("Bloco", u -> ((Unidade) u).getBloco());
        adicionarColuna("Número", u -> ((Unidade) u).getNumero());
        adicionarColuna("Proprietário", u -> ((Unidade) u).getProprietario());
        adicionarColuna("Situação", u -> ((Unidade) u).getSituacao());
        adicionarColuna("Telefone", u -> ((Unidade) u).getTelefoneContato());
        adicionarColuna("E-mail", u -> ((Unidade) u).getEmailContato());
    }

    private void configurarTabelaMoradores() {
        tabelaRelatorio.getColumns().clear();

        adicionarColuna("Nome", m -> ((Morador) m).getNome());
        adicionarColuna("CPF", m -> ((Morador) m).getCpf());
        adicionarColuna("Unidade", m -> String.valueOf(((Morador) m).getIdUnidade()));
        adicionarColuna("Telefone", m -> ((Morador) m).getTelefone());
        adicionarColuna("E-mail", m -> ((Morador) m).getEmail());
        adicionarColuna("Tipo", m -> ((Morador) m).getTipo());
        adicionarColuna("Situação", m -> ((Morador) m).getSituacao());
    }

    private void configurarTabelaTaxas() {
        tabelaRelatorio.getColumns().clear();

        adicionarColuna("Unidade", t -> ((Taxa) t).getUnidadeTexto());
        adicionarColuna("Descrição", t -> ((Taxa) t).getDescricao());
        adicionarColuna("Valor", t -> ((Taxa) t).getValor() != null ? ((Taxa) t).getValor().toString() : "");
        adicionarColuna("Vencimento", t -> formatarData(((Taxa) t).getVencimento()));
        adicionarColuna("Situação", t -> ((Taxa) t).getSituacao());
    }

    private void configurarTabelaReservas() {
        tabelaRelatorio.getColumns().clear();

        adicionarColuna("Unidade", r -> ((Reserva) r).getUnidadeFormatada());
        adicionarColuna("Área comum", r -> ((Reserva) r).getAreaComum());
        adicionarColuna("Data", r -> formatarData(((Reserva) r).getData()));
        adicionarColuna("Início", r -> ((Reserva) r).getHoraInicio() != null ? ((Reserva) r).getHoraInicio().toString() : "");
        adicionarColuna("Fim", r -> ((Reserva) r).getHoraFim() != null ? ((Reserva) r).getHoraFim().toString() : "");
        adicionarColuna("Situação", r -> ((Reserva) r).getSituacao());
    }

    private void configurarTabelaOcorrencias() {
        tabelaRelatorio.getColumns().clear();

        adicionarColuna("Local", o -> ((Ocorrencia) o).getLocalFormatado());
        adicionarColuna("Título", o -> ((Ocorrencia) o).getTitulo());
        adicionarColuna("Categoria", o -> ((Ocorrencia) o).getCategoria());
        adicionarColuna("Situação", o -> ((Ocorrencia) o).getSituacao());
        adicionarColuna("Data de abertura", o -> ((Ocorrencia) o).getDataAbertura() != null
    ...
    private void configurarTabelaManutencoes() {
        ...
        adicionarColuna("Descrição", m -> ((Manutencao) m).getDescricao());
        adicionarColuna("Local", m -> ((Manutencao) m).getLocal());
        adicionarColuna("Responsável", m -> ((Manutencao) m).getResponsavel());
        adicionarColuna("Solicitação", m -> formatarData(((Manutencao) m).getDataSolicitacao()));
        adicionarColuna("Situação", m -> ((Manutencao) m).getSituacao());
        adicionarColuna("Custo", m -> ((Manutencao) m).getCusto() != null ? ((Manutencao) m).getCusto().toString() : "");
    }
    ...
    private void adicionarColuna(String titulo, Function<Object, String> valor) {
        TableColumn<Object, String> coluna = new TableColumn<>(titulo);

        coluna.setCellValueFactory(cell ->
                new SimpleStringProperty(valor.apply(cell.getValue()))
        );
